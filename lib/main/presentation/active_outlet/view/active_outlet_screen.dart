...
class ActiveOutletScreen extends StatelessWidget {
  const ActiveOutletScreen({super.key});
  @override
            ...
            Padding(
              ...
              child: SharedWidget.defaultTextFormField(
                ...
                onFieldSubmitted: (String? value) {
                  ViewOutletBloc.get(context).searchActive(value!);
                },
              ),
            ),
            Expanded(
              child: ConditionalBuilderRec(
                ...
                builder: (context) => itemBuilder(
                  ViewOutletBloc.get(context).resturantActive,
                ),
...
Widget itemBuilder(List<ResturantModel> list) => ListView.builder(
      ...
      itemBuilder: (context, index) => InkWell(
        onTap: () {
          showActiveDialog(context, list[index]);
        },
        child: Padding(
          padding: EdgeInsets.symmetric(
