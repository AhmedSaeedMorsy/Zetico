...
import '../controller/add_outlet_reg_states.dart';

class AddOutletRegView extends StatelessWidget {
  AddOutletRegView({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AddOutletRegBloc, AddOutletRegStates>(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SharedWidget.dropDown(
                                ...
                                validator: (String? value) {
                                  if (value == null) {
                                    return AppStrings.outletSpaceValidateText
                                        .tr();
                                  }
                                  return null;
                                },
