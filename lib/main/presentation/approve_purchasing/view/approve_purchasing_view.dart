...
import 'package:zetico/main/presentation/approve_purchasing/controller/approve_purchasing_states.dart';
...
class ApprovePurchasingView extends StatelessWidget {
  ApprovePurchasingView({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ApprovePurchasingBloc, ApprovePurchasingStates>(
        listener: (context, state) {
      if (state is ApprovePurchasingSuccessStates) {
      ...
      city = outlet.cityEn!;
      controllerAgreementByDate.text =
            ...
            children: [
                    ...
                    child: item(
                      ...
                      onTap: () {
                        showDatePicker(
                          ...
                          lastDate: DateTime.parse(AppStrings.calenderEndDate),
                        ).then(
                          (value) {
                            controllerAgreementStartDate.text =
                    ...
                    child: item(
                        ...
                        onTap: () async {
                          showDatePicker(
                            ...
                            (value) {
                              controllerAgreementEndDate.text =
                                  DateFormat.yMMMd().format(value!);
                            },
                          );
                        }),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Checkbox(
                      value: ApprovePurchasingBloc.get(context).contract,
                      onChanged: ((value) {
                        ApprovePurchasingBloc.get(context).changeContract();
                        contract = ApprovePurchasingBloc.get(context).contract;
                      }),
                    ),
                    Text(
                        ...
                        child: MaterialButton(
                          onPressed: () {
                            if (formkey.currentState!.validate()) {
                              ApprovePurchasingBloc.get(context)
                                  .approvePurchasing(
