...
import 'package:zetico/main/presentation/on_progress_orders/controller/on_progress_orders_states.dart';
...
import 'on_progress_orders_dialog.dart';

class OnProgressOrdersView extends StatelessWidget {
  const OnProgressOrdersView({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<OnProgressOrdersBloc, OnProgressOrdersStates>(
        ...
        children: [
          ...
          Expanded(
            child: ConditionalBuilderRec(
              condition: state is OnProgressOrdersSuccessState,
              builder: (context) => itemBuilder(
                OnProgressOrdersBloc.get(context).onProgressOrdersModel.orders,
              ),
  ...
  Widget itemBuilder(List<OnProgressModel> order) => ListView.builder(
        physics: const BouncingScrollPhysics(),
        itemCount: order.length,
        itemBuilder: (context, index) => InkWell(
          onTap: () {
            showOnProgressDialog(context: context, order: order[index]);
          },
          child: Padding(
            padding: EdgeInsets.symmetric(
